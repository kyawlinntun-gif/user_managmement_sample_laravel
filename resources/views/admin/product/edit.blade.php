        ...
        <div class="card my-4">
          ...
          <div class="card-body px-0 pb-2">
            <div class="row">
              ...
              @enderror
              <form role="form" method="POST" action="{{ url('/admin/products/' . $product->id) }}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="input-group input-group-outline mb-3">
                  <input type="text" class="form-control" placeholder="Product Name" value="{{ old('product_name') ?? $product->name }}" name="product_name">
                </div>
                @error('product_name')
