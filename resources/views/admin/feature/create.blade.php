        ...
        <div class="card my-4">
          ...
          <div class="card-body px-0 pb-2">
            <div class="row">
              ...
              @enderror
              <form role="form" method="POST" action="{{ url('/admin/features/create') }}">
                @csrf
                <div class="input-group input-group-outline mb-3">
                  <input type="text" class="form-control" placeholder="Feature Name" value="{{ old('feature_name') }}" name="feature_name">
                </div>
                @error('feature_name')
